...
export class ErrorValidationComponent
  ...
  errorMessages: Map<string, string> = new Map<string, string>([
    ...
    ["requiredTrue", "VALIDATION-MESSAGES.requiredTrue"],
    ["date", "VALIDATION-MESSAGES.date"],
    ["notArabic", "VALIDATION-MESSAGES.notArabic"],
    ["notEnglish", "VALIDATION-MESSAGES.notEnglish"],
    ["notUrl", "VALIDATION-MESSAGES.notUrl"],
    ["notMobile", "VALIDATION-MESSAGES.notMobile"],
    ["notCurrency", "VALIDATION-MESSAGES.notCurrency"],
    ["notNumber", "VALIDATION-MESSAGES.notNumber"],
    ["notAlphaArabic", "VALIDATION-MESSAGES.notAlphaArabic"],
    ["notAlphaEnglish", "VALIDATION-MESSAGES.notAlphaEnglish"],
    ["notEmail", "VALIDATION-MESSAGES.notEmail"],
    ["notCreditcard", "VALIDATION-MESSAGES.notCreditcard"],
    ["notDate", "VALIDATION-MESSAGES.notDate"],
  ]);
